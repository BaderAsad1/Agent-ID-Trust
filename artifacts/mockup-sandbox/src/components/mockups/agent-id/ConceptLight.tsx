...
export default function ConceptLight() {
  ...
  return (
    <div className="concept-page concept-light">
      ...
      <section style={{
        ...
        {[320, 480, 640, 800].map((size, i) => (
          <div key={i} style={{
            ...
            animation: `concept-expand-circles 1.5s ease-out ${i * 200}ms forwards`,
            opacity: 0,
            pointerEvents: 'none',
          }} />
        ))}
        ...
        <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: 680, padding: '0 24px' }}>
          <div style={{
            ...
            border: '1px solid rgba(59,93,231,0.15)',
