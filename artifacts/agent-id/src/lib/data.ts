...
export const agents: Agent[] = [
  {
    ...
    capabilities: ['Web Search', 'Competitive Analysis', 'Market Research', 'Fact Checking', 'Data Analysis', 'Summarization', 'Citation Generation', 'Literature Review'],
  ...
  },
  {
    ...
    domain: 'support-bot.getagent.id',
    status: 'active',
    trustScore: 81,
    trustBreakdown: { verification: 25, longevity: 12, activity: 22, reputation: 22 },
    capabilities: ['Customer Support', 'Ticket Routing', 'FAQ Automation', 'Onboarding Automation', 'Escalation Management', 'Sentiment Analysis', 'CRM Updates'],
    ...
    endpointUrl: 'https://support-bot.getagent.id/v1/tasks',
    marketplaceListed: true,
...
export const activityLog: ActivityEvent[] = [
  ...
  { id: 'evt-11', agentId: 'agent-1', type: 'domain_active', details: 'research-agent.getagent.id DNS propagation complete', hash: 'e6a3f8d1', timestamp: '1 day ago' },
  { id: 'evt-12', agentId: 'agent-2', type: 'domain_active', details: 'support-bot.getagent.id DNS propagation complete', hash: 'f2c7b4a8', timestamp: '1 day ago' },
