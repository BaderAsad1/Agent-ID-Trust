      ...
      <div className="max-w-[740px] mx-auto px-6 py-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <section>
            ...
            <p className="mb-3">Handle registration fees (ENS-style, annual): 1–2 character handles are reserved and not available; 3-character handles $640/year; 4-character handles $160/year; 5+ character handles $10/year (included at no extra cost with any active Starter, Pro, or Enterprise subscription during the first year). Handles subject to a 90-day grace period after expiry, followed by a 21-day decreasing premium auction.</p>
