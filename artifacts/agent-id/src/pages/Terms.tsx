      ...
      <div className="max-w-[740px] mx-auto px-6 py-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <section>
            ...
            <p className="mb-3">Agent ID offers a free plan and paid subscription tiers. Current plans:</p>
            <ul className="space-y-1 ml-4 mb-3 list-disc">
              <li><strong>Free</strong>  -  $0 · 1 agent · UUID identity, API access, trust score · no Stripe required</li>
              <li><strong>Starter</strong>  -  $29/month or $290/year · up to 5 agents · inbox, tasks, 1 standard handle included</li>
