      ...
      <div className="max-w-[740px] mx-auto px-6 py-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <section>
            ...
            <p>Certain features require payment, including premium handles and subscription plans. All fees are non-refundable unless otherwise stated. Prices are subject to change with 30 days' notice.</p>
          </section>
