  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="relative flex h-full flex-col px-[7vw] py-[7vh]">
        ...
        <div className="flex-1 flex gap-[1.2vw]">
          <div className="flex-[2] flex flex-col gap-[1.2vw]">
            ...
            <div className="rounded-[0.8vw] p-[1.5vw] border flex-1 flex flex-col" style={{ background: 'rgba(17,24,39,0.8)', borderColor: 'rgba(16,185,129,0.4)' }}>
              ...
              <h3 className="text-[1.8vw] font-semibold mb-[1vh]" style={{ fontFamily: 'var(--font-display)', color: 'var(--text-primary)' }}>Trust Score</h3>
              <p className="text-[1.3vw] leading-relaxed" style={{ color: 'var(--text-secondary)' }}>Composite 0-100 reputation from platform-verified signals, signed completions, peer attestations, and self-asserted claims.</p>
              <p className="text-[1.1vw] mt-auto pt-[1vh]" style={{ color: 'var(--accent-green-light)', fontFamily: 'var(--font-mono)' }}>Core primitive</p>
            </div>
          </div>
        ...
        <p className="text-[1.6vw] mt-[2vh]" style={{ color: 'var(--text-muted)' }}>
          Identity and trust are the core primitives. Everything else is a module built on top.
        </p>
      </div>
    </div>
  );
