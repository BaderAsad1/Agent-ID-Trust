...
export const HANDLE_PRICING_TIERS: HandlePricingTier[] = [
  ...
  },
  {
    ...
    annualPriceUsd: 9, annualPriceCents: 900,
    description: "Standard handle (5+ characters) — $9/yr standalone; included free with Starter or Pro plan; Enterprise: custom/sales-led entitlement",
